    ...
    <div class="chongwuzixun-add" v-loading="loading">
        <el-card class="box-card">
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                <el-form-item label="标题" prop="biaoti" required :rules="[{required:true, message:'请填写标题'}, {validator:rule.checkRemote, message:'内容重复了', checktype:'insert', module:'chongwuzixun', col:'biaoti', trigger:'blur'}]">
        ...
        methods: {
            submit(){
                this.$refs.formModel.validate().then(res=>{
                    ...
                    this.$post(api.chongwuzixun.insert , form).then(res=>{
                        this.loading = false;
            ...
            loadInfo(){
                ...
                // 获取模块得数据
                this.loading = true;
                this.$post(api.chongwuzixun.create , {
