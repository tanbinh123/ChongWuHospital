<template>
    ...
    <div class="chongwuzixun-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
                ...
                <div class="detail-content">
                     <e-select-view module="zixunfenlei" :value="map.fenlei" select="id" show="fenleimingcheng"></e-select-view>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail(){
                ...
                this.loading = true;
                this.$get(api.chongwuzixun.detail , {
                    id:this.id
                }).then(res=>{
                    this.loading = false;
