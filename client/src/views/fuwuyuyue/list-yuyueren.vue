                ...
                <el-table-column label="操作">
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-button v-if="row.yuyuezhuangtai == '已处理'" @click="$goto('/admin/pinglunadd?id='+row.id)" type="success" icon="el-icon-plus"
                                       size="mini">
                                评论
                            </el-button>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.fuwuyuyue.listyuyueren, filter).then(res => {
                    this.loading = false;
