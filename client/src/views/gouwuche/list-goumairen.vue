            ...
            <div class="form-search">
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="购买数量">
                        ...
                        <el-input type="text" style="width:80px;" v-model="search.goumaishuliang_start"></el-input>
                        -
                        <el-input type="text" style="width:80px;" v-model="search.goumaishuliang_end"></el-input>
...
{{ row.addtime.substr(0,16) }}
            ...
            <div>
                ...
                <el-button type="danger" @click="$goto('/admin/dingdanxinxiadd?sum_xiaoji='+total.sum_xiaoji)" size="mini">生成订单</el-button>
            </div>
        </el-card>
    </div>
</template>
