<template>
    <div class="huifupinglun-add" v-loading="loading">
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                                    <el-page-header @back="$router.go(-1)" content="编辑回复评论">
                    </el-page-header>
                            </div>
            ...
            <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                                ...
                                <el-form-item v-if="isRead" label="评分" prop="pingfen">
                                            {{  form.pingfen  }}                                    </el-form-item>

                                <el-form-item v-if="isRead" label="评论内容" prop="pinglunneirong">
                                            {{  form.pinglunneirong  }}                                    </el-form-item>
        ...
        methods: {
            submit(){
                this.$refs.formModel.validate().then(res=>{
                    ...
                    this.$post(api.huifupinglun.update , form).then(res=>{
                        this.loading = false;
            ...
            loadInfo(){
                ...
                this.loading = true;
                var form = this.form;
                this.$post(api.huifupinglun.edit , {
                    id:this.id
                }).then(res=>{
                    this.loading = false;
                    if(res.code == api.code.OK){
